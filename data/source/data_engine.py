...
class DataEngine():
    ...
    def __init__(self, session=ccxt.binance(), path_to_data='./data/database/'):
    ...
    def get_historical_from_api(self, symbol, timeframe, start_date, limit=1000):
        ...
        @param start_date string: a date in specif format i.e 2021-01-01T00:00:00
    ...
    def download_data(self, symbols, timeframes, start_date='2021-01-01T00:00:00'):
        '''
        ...
        for symbol in symbols:
            for tf in timeframes:
                print(f'-> downloading symbol {symbol} for timeframe {tf}')
        ...
        for symbol in symbols:
            for tf in timeframes:
                try:
                    ...
                    # Permettre l’initialisation des données avec la fonction update
                    #if os.path.exists(fileName):
                    #    os.remove(fileName)
